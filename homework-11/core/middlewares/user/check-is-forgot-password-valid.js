const { ErrorHandler, errorMessage: { BODY_NOT_VALID, USER_NOT_FOUND }, errorCode } = require('../../Error');
...
module.exports = async (req, res, next) => {
    try {
        ...
        if (!user) {
            throw new ErrorHandler(errorCode.NOT_FOUND, USER_NOT_FOUND.customCode, 'User not found');
        }
